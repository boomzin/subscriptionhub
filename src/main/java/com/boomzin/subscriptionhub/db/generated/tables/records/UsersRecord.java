...
public class UsersRecord extends UpdatableRecordImpl<UsersRecord> {
     ...
     */
    public UsersRecord setRoleId(UUID value) {
        set(4, value);
        return this;
    }
     ...
     */
    public UsersRecord(UUID id, String email, String passwordHash, LocalDateTime createdAt, UUID roleId) {
        super(Users.USERS);
     ...
     * Create a detached, initialised UsersRecord
     */
    public UsersRecord(com.boomzin.subscriptionhub.db.generated.tables.pojos.Users value) {
        super(Users.USERS);
