...
public class Subscriptions extends TableImpl<SubscriptionsRecord> {
     ...
     */
    public final TableField<SubscriptionsRecord, LocalDate> START_DATE = createField(DSL.name("start_date"), SQLDataType.LOCALDATE.nullable(false), this, "");
     ...
     */
    public final TableField<SubscriptionsRecord, LocalDate> END_DATE = createField(DSL.name("end_date"), SQLDataType.LOCALDATE, this, "");
